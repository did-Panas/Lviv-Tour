(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-schedule__slider_1")) new core(".slider-schedule__slider_1", {
            modules: [ Navigation, Pagination, Parallax, Lazy ],
            observer: true,
            observeParents: true,
            ...
            parallax: true,
            pagination: {
                el: ".slider-schedule__pagination_1",
                clickable: false
            },
            navigation: {
                prevEl: ".slider-schedule__button-prev_1",
                nextEl: ".slider-schedule__button-next_1"
            },
            on: {}
        });
        if (document.querySelector(".slider-schedule__slider_2")) new core(".slider-schedule__slider_2", {
            modules: [ Navigation, Pagination, Parallax, Lazy ],
            observer: true,
            observeParents: true,
            observeSlideChildren: true,
            ...
            parallax: true,
            pagination: {
                el: ".slider-schedule__pagination_2",
                clickable: false
            },
            navigation: {
                prevEl: ".slider-schedule__button-prev_2",
                nextEl: ".slider-schedule__button-next_2"
            },
            on: {}
        });
        if (document.querySelector(".slider-schedule__slider_3")) new core(".slider-schedule__slider_3", {
            modules: [ Navigation, Pagination, Parallax, Lazy ],
            observer: true,
            observeParents: true,
            observeSlideChildren: true,
            ...
            parallax: true,
            pagination: {
                el: ".slider-schedule__pagination_3",
                clickable: false
            },
            navigation: {
                prevEl: ".slider-schedule__button-prev_3",
                nextEl: ".slider-schedule__button-next_3"
            },
            on: {}
        });
        if (document.querySelector(".slider-schedule__slider_4")) new core(".slider-schedule__slider_4", {
            modules: [ Navigation, Pagination, Parallax, Lazy ],
            observer: true,
            observeParents: true,
            observeSlideChildren: true,
            ...
            parallax: true,
            pagination: {
                el: ".slider-schedule__pagination_4",
                clickable: false
            },
            navigation: {
                prevEl: ".slider-schedule__button-prev_4",
                nextEl: ".slider-schedule__button-next_4"
            },
            on: {}
        });
        if (document.querySelector(".slider-schedule__slider_5")) new core(".slider-schedule__slider_5", {
            modules: [ Navigation, Pagination, Parallax, Lazy ],
            observer: true,
            observeParents: true,
            observeSlideChildren: true,
            ...
            parallax: true,
            pagination: {
                el: ".slider-schedule__pagination_5",
                clickable: false
            },
            navigation: {
                prevEl: ".slider-schedule__button-prev_5",
                nextEl: ".slider-schedule__button-next_5"
            },
            on: {}
        });
        if (document.querySelector(".slider-schedule__slider_6")) new core(".slider-schedule__slider_6", {
            modules: [ Navigation, Pagination, Parallax, Lazy ],
            observer: true,
            observeParents: true,
            observeSlideChildren: true,
            ...
            parallax: true,
            pagination: {
                el: ".slider-schedule__pagination_6",
                clickable: false
            },
            navigation: {
                prevEl: ".slider-schedule__button-prev_6",
                nextEl: ".slider-schedule__button-next_6"
            },
            on: {}
        });
    }
